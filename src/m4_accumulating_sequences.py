...
def run_test_make_simple_list():
    ...
    actual = make_simple_list(2, 15)
    print('\nExpected:', expected)
    print('Actual:  ', actual)

    expected = [10, 11, 12, 13]
    actual = make_simple_list(10, 13)
    print('\nExpected:', expected)
    print('Actual:  ', actual)
...
def run_test_make_less_simple_string():
    ...
    expected = "8-9"
    actual = make_less_simple_string(8, 9)
    print('\nExpected:', expected)
    print('Actual:  ', actual)
...
def rectangles_from_circles(circles):
    ...
    rectangle_list = []
    for i in circles:
        rectangle_list = rectangle_list + [rg.Rectangle(rg.Point(i.center.x - i.radius, i.center.y - i.radius),
                                                        rg.Point(i.center.x + i.radius, i.center.y + i.radius))]
